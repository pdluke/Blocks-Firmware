...
#define STRING_CONFIG_H_AUTHOR "(Blocks, zero 1.3.1b)" // Who made the changes.
...
#define MACHINE_UUID "03402dec-1cb0-4fe0-a26c-4c2fe7dc9752"
...
#define HOMING_FEEDRATE {2000, 2000, 180, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 4000,105}  // default steps per unit for Ultimaker
...
#define FILAMENT_UNLOAD_RETRACTION_LENGTH 600
